...
INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (2, 'Piscina', 'Piscina Adultos', 'Piscina');

INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (3, 'Gimnasio', 'Gimnasio Principal', 'Gimnasio');

INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (4, 'Internet', 'WI-FI 5G', 'Internet');

INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (5, 'Lavanderia', 'Lavanderia Sotano', 'Lavanderia');

INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (6, 'Prestamo', 'Toallas', 'Prestamo');

INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (7, 'Spa', 'Spa 8vo Piso', 'Spa');

INSERT INTO SERVICIOS (ID, NOMBRE, DESCRIPCION, TIPOSERVICIO)
VALUES (8, 'Salon', 'Salon Principal #2', 'Salon');
