...
INSERT INTO RESERVASSERViCIO (ID, FECHA, HORAINICIO, HORAFIN, RESERVAS_ID, SERVICIOS_ID)
VALUES (2, TO_DATE('2021-02-15', 'YYYY-MM-DD'), TO_DATE('15:30', 'HH24:MI'), TO_DATE('16:30', 'HH24:MI'), 2, 2);

INSERT INTO RESERVASSERViCIO (ID, FECHA, HORAINICIO, HORAFIN, RESERVAS_ID, SERVICIOS_ID)
VALUES (3, TO_DATE('2021-03-20', 'YYYY-MM-DD'), TO_DATE('09:00', 'HH24:MI'), TO_DATE('10:30', 'HH24:MI'), 1, 3);

INSERT INTO RESERVASSERViCIO (ID, FECHA, HORAINICIO, HORAFIN, RESERVAS_ID, SERVICIOS_ID)
VALUES (4, TO_DATE('2021-04-10', 'YYYY-MM-DD'), TO_DATE('14:00', 'HH24:MI'), TO_DATE('16:00', 'HH24:MI'), 3, 1);

INSERT INTO RESERVASSERViCIO (ID, FECHA, HORAINICIO, HORAFIN, RESERVAS_ID, SERVICIOS_ID)
VALUES (5, TO_DATE('2021-05-05', 'YYYY-MM-DD'), TO_DATE('11:30', 'HH24:MI'), TO_DATE('13:00', 'HH24:MI'), 2, 3);

-- ESTABLECIMIENTOCONSUMO

INSERT INTO ESTABLECIMIENTOS (SERVICIOS_ID, TIPOESTABLECIMIENTO, ESTILO, CAPACIDAD)
VALUES (1, 'Tienda', 'Jazz', 50);

INSERT INTO ESTABLECIMIENTOS (SERVICIOS_ID, TIPOESTABLECIMIENTO, ESTILO, CAPACIDAD)
VALUES (2, 'Bar', 'Internacional', 5);

-- PISCINA

INSERT INTO PISCINAS (SERVICIOS_ID, CAPACIDAD, PROFUNDIDAD, HORARIOSERVICIO)
VALUES (3, 10, 2, 'Nocturno');

-- GIMNASIO

INSERT INTO GIMNASIOS (SERVICIOS_ID, CAPACIDAD, NUMMAQUINAS, HORARIOSERVICIO)
VALUES (4, 10, 20, 'Diurno');

-- INTERNET

INSERT INTO INTERNET (SERVICIOS_ID, CAPACIDAD, COSTOXDIA)
VALUES (5, 200, 75);

-- LAVANDERIA

INSERT INTO LAVANDERIAS (SERVICIOS_ID, TIPOPRENDA, COSTOXPRENDA)
VALUES (6, 'Zapatos', 50);

-- PRESTAMO

INSERT INTO PRESTAMOS (SERVICIOS_ID, UTENSILIO, COSTOREMPLAZO)
VALUES (7, 'Toallas', 200);
...
VALUES (9, 'SalonConferencia', 5, 5000);
...
INSERT INTO PRODUCTOS (ID, NOMBRE, PRECIO)
VALUES (2, 'Souvenir', 50);

INSERT INTO PRODUCTOS (ID, NOMBRE, PRECIO)
VALUES (3, 'Gafas de sol', 15);

INSERT INTO PRODUCTOS (ID, NOMBRE, PRECIO)
VALUES (4, 'Cerveza', 500);
...
INSERT INTO OFRECENPRODUCTOS (ESTABLECIMIENTO_ID, PRODUCTOS_ID)
VALUES (1, 1);
